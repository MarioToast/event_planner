    ...
    return (
        <div className="event-planner-container">
            ...
            <section className="description">
                ...
                <button className="get-started-button">Let's get 'er done, bucko</button>
            </section>
            ...
            <section className="testimonials">
                    ...
                    <div className="testimonial">
                        <p>"My latest event was killer thanks to Event Planner."</p>
                        <p className="author">- Tobias Rieper</p>
                    </div>
            </section>
